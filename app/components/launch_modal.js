          ...
          <ModalBody>
            ...
            <Row className="form-group">
              <Col md={24}>
                ...
                <input type="text" autoFocus={true} required={true} className="form-control" id="receptor-url" name="receptor_url" placeholder="http://receptor.example.com" value={receptorUrl} onChange={this.change}/>
              </Col>
            </Row>
            <Divider/>
          </ModalBody>
